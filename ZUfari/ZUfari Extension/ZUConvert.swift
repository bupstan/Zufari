...
public struct ZUConvert {
    public static func convertToUnicode(_ zawgyiString: String) -> String {
        let rules = [["from": "([\u{102D}\u{102E}\u{103D}\u{102F}\u{1037}\u{1095}])\\1+", "to": "$1"],
                     ["from": "\u{200B}", "to": ""],
                     ["from": "\u{103d}\u{103c}", "to": "\u{108a}"],
                     ...
                     ["from": "(\u{1066}|\u{1067})", "to": "\u{1039}\u{1006}"],
                     ...
                     ["from": "(\u{1073}|\u{1074})", "to": "\u{1039}\u{1011}"],
                     ...
                     ["from": "\u{1036}\u{1088}", "to": "\u{1088}\u{1036}"],
                     ["from": "\u{1088}", "to": "\u{103e}\u{102f}"],
                     ["from": "\u{1089}", "to": "\u{103e}\u{1030}"],
                     ["from": "\u{108a}", "to": "\u{103d}\u{103e}"],
                     ["from": "\u{103B}\u{1064}", "to": "\u{1064}\u{103B}"],
                     ["from": "(\u{1031})?([\u{1000}-\u{1021}])\u{1064}", "to": "\u{1004}\u{103a}\u{1039}$1$2"],
                     ["from": "(\u{1031})?([\u{1000}-\u{1021}])(\u{103b})?\u{108b}", "to": "\u{1004}\u{103a}\u{1039}$1$2$3\u{102d}"],
                     ["from": "(\u{1031})?([\u{1000}-\u{1021}])(\u{103b})?\u{108c}", "to": "\u{1004}\u{103a}\u{1039}$1$2$3\u{102e}"],
                     ["from": "(\u{1031})?([\u{1000}-\u{1021}])\u{108d}", "to": "\u{1004}\u{103a}\u{1039}$1$2\u{1036}"],
                     ["from": "\u{108e}", "to": "\u{102d}\u{1036}"],
                     ["from": "\u{108f}", "to": "\u{1014}"],
                     ["from": "\u{1090}", "to": "\u{101b}"],
                     ["from": "\u{1091}", "to": "\u{100f}\u{1039}\u{100d}"],
                     ["from": "\u{1092}", "to": "\u{100b}\u{1039}\u{100c}"],
                     ["from": "\u{1019}\u{102c}(\u{107b}|\u{1093})", "to": "\u{1019}\u{1039}\u{1018}\u{102c}"],
                     ["from": "(\u{107b}|\u{1093})", "to": "\u{1039}\u{1018}"],
                     ["from": "(\u{1094}|\u{1095})", "to": "\u{1037}"],
                     ["from": "([\u{1000}-\u{1021}])\u{1037}\u{1032}", "to": "$1\u{1032}\u{1037}"],
                     ...
                     ["from": "\u{1047}(?=[\u{102c}-\u{1030}\u{1032}\u{1036}-\u{1038}\u{103d}\u{1038}])", "to": "\u{101b}"],
                     ["from": "\u{1031}\u{1047}", "to": "\u{1031}\u{101b}"],
                     ["from": "\u{1040}(\u{102e}|\u{102f}|\u{102d}\u{102f}|\u{1030}|\u{1036}|\u{103d}|\u{103e})", "to": "\u{101d}$1"],
                     ["from": "[^\u{1040}\u{1041}\u{1042}\u{1043}\u{1044}\u{1045}\u{1046}\u{1047}\u{1048}\u{1049}])\u{1040}\u{102b}", "to": "$1\u{101d}\u{102b}"],
                     ["from": "([\u{1040}\u{1041}\u{1042}\u{1043}\u{1044}\u{1045}\u{1046}\u{1047}\u{1048}\u{1049}])\u{1040}\u{102b}(?!\u{1038})", "to": "$1\u{101d}\u{102b}"],
                     ["from": "^\u{1040}(?=\u{102b})", "to": "\u{101d}"],
                     ["from": "\u{1040}\u{102d}(?!\u{0020}?/)", "to": "\u{101d}\u{102d}"],
                     ["from": "([^\u{1040}-\u{1049}])\u{1040}([^\u{1040}-\u{1049}\u{0020}]|[\u{104a}\u{104b}])", "to": "$1\u{101d}$2"],
                     ["from": "([^\u{1040}-\u{1049}])\u{1040}(?=[\\f\\n\\r])", "to": "$1\u{101d}"],
                     ["from": "([^\u{1040}-\u{1049}])\u{1040}$", "to": "$1\u{101d}"],
                     ["from": "\u{1031}([\u{1000}-\u{1021}\u{103f}])(\u{103e})?(\u{103b})?", "to": "$1$2$3\u{1031}"],
                     ["from": "([\u{1000}-\u{1021}])\u{1031}([\u{103b}\u{103c}\u{103d}\u{103e}]+)", "to": "$1$2\u{1031}"],
                     ["from": "\u{1032}\u{103d}", "to": "\u{103d}\u{1032}"],
                     ["from": "([\u{102d}\u{102e}])\u{103b}", "to": "\u{103b}$1"],
                     ...
                     ["from": "(\u{103e})(\u{103b}|\u{103c})", "to": "$2$1"],
                     ["from": "\u{1025}(?=[\u{1037}]?[\u{103a}\u{102c}])", "to": "\u{1009}"],
                     ...
                     ["from": "([\u{1000}-\u{1021}])\u{103c}\u{1031}\u{103d}", "to": "$1\u{103c}\u{103d}\u{1031}"],
                     ["from": "([\u{1000}-\u{1021}])\u{103b}\u{1031}\u{103d}(\u{103e})?", "to": "$1\u{103b}\u{103d}$2\u{1031}"],
                     ["from": "([\u{1000}-\u{1021}])\u{103d}\u{1031}\u{103b}", "to": "$1\u{103b}\u{103d}\u{1031}"],
                     ["from": "([\u{1000}-\u{1021}])\u{1031}(\u{1039}[\u{1000}-\u{1021}])", "to": "$1$2\u{1031}"],
                     ["from": "\u{1038}\u{103a}", "to": "\u{103a}\u{1038}"],
                     ["from": "\u{102d}\u{103a}|\u{103a}\u{102d}", "to": "\u{102d}"],
                     ["from": "\u{102d}\u{102f}\u{103a}", "to": "\u{102d}\u{102f}"],
                     ["from": "\u{0020}\u{1037}", "to": "\u{1037}"],
                     ["from": "\u{1037}\u{1036}", "to": "\u{1036}\u{1037}"],
                     ["from": " \u{1037}", "to": "\u{1037}"],
                     ["from": "[\u{102d}]+", "to": "\u{102d}"],
                     ["from": "[\u{103a}]+", "to": "\u{103a}"],
                     ["from": "[\u{103d}]+", "to": "\u{103d}"],
                     ["from": "[\u{1037}]+", "to": "\u{1037}"],
                     ["from": "[\u{102e}]+", "to": "\u{102e}"],
                     ["from": "\u{102d}\u{102e}|\u{102e}\u{102d}", "to": "\u{102e}"],
                     ["from": "\u{102f}\u{102d}", "to": "\u{102d}\u{102f}"],
                     ["from": "\u{1037}\u{1037}", "to": "\u{1037}"],
                     ["from": "\u{1032}\u{1032}", "to": "\u{1032}"],
                     ["from": "\u{1044}\u{1004}\u{103a}\u{1038}", "to": "\u{104E}\u{1004}\u{103a}\u{1038}"],
                     ["from": "([\u{102d}\u{102e}])\u{1039}([\u{1000}-\u{1021}])", "to": "\u{1039}$2$1"],
                     ["from": "(\u{103c}\u{1031})\u{1039}([\u{1000}-\u{1021}])", "to": "\u{1039}$2$1"],
                     ["from": "\u{1036}\u{103d}", "to": "\u{103d}\u{1036}"]]
        print(zawgyiString)
...
//        Code to generate unicoded rule in editor
//        var tmpRules = rules
